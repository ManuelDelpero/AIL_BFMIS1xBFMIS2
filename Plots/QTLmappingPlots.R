...
JAX00074330 <- cbind(phenotypes[, "Gon"], t(genotypes["JAX00074330",]))
...
boxplot(as.numeric(JAX00074330[which(JAX00074330[,2] == "A"),1]), as.numeric(JAX00074330[which(JAX00074330[,2] == "H"),1]), as.numeric(JAX00074330[which(JAX00074330[,2] == "B"),1]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "Gonadal adipose tissue weight [Chr 17]", ylab = "Weight [Gr.]", xlab = "Genotypes [JAX00074330]" , las = 2, t = "n", xaxt = "n",  ylim = c(0, 7))
  axis(1, at = 1:3 , c("TT", "TC", "CC"))
  legend("topright", #bg="gray",
  legend = c( "BFMI-S1", "HET", "BFMI-S2"),
    col = c("lightskyblue1", "cyan3", "dodgerblue4"),
...
boxplot(as.numeric(ICR889[which(ICR889[,2] == "A"),1]), as.numeric(ICR889[which(ICR889[,2] == "H"),1]), as.numeric(ICR889[which(ICR889[,2] == "B"),1]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "Liver weight [Chr 17]", ylab = "Weight [Gr.]", xlab = "Genotypes [ICR889]" , las = 2, t = "n", xaxt = "n",  ylim = c(0, 8))
  axis(1, at = 1:3 , c("TT", "TC", "CC"))
  legend("topright", #bg="gray",
  legend = c( "BFMI-S1", "HET", "BFMI-S2"),
    col = c("lightskyblue1", "cyan3", "dodgerblue4"),
...
boxplot(as.numeric(JAX00432128[which(JAX00432128[,2] == "A"),1]), as.numeric(JAX00432128[which(JAX00432128[,2] == "H"),1]), as.numeric(JAX00432128[which(JAX00432128[,2] == "B"),1]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "Glucose day 172 [Chr 17]", ylab = "Glucose [mg/dL]", xlab = "Genotypes[JAX00432128]" , ylim = c(0, 600), las = 2, t = "n", xaxt = "n")
  axis(1, at = 1:3 , c("TT", "TC", "CC"))
  legend("topright", #bg="gray",
  legend = c( "BFMI-S1", "HET", "BFMI-S2"),
    col = c("lightskyblue1", "cyan3", "dodgerblue4"),
...
boxplot(as.numeric(UNC5791802[which(UNC5791802[,2] == "B"),1]), as.numeric(UNC5791802[which(UNC5791802[,2] == "H"),1]), as.numeric(UNC5791802[which(UNC5791802[,2] == "A"),1]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "Glucose day 172 [Chr 3]", ylab = "Glucose [mg/dL]", xlab = "Genotypes[UNC5791802]",  ylim = c(0, 600), las = 2, t = "n", xaxt = "n")
  axis(1, at = 1:3 , c("TT", "TC", "CC"))
  legend("topright", #bg="gray",
  legend = c( "BFMI-S1", "HET", "BFMI-S2"),
    col = c("lightskyblue1", "cyan3", "dodgerblue4"),
...
boxplot(as.numeric(UNCHS041714[which(UNCHS041714[,2] == "A"),1]), as.numeric(UNCHS041714[which(UNCHS041714[,2] == "H"),1]), as.numeric(UNCHS041714[which(UNCHS041714[,2] == "B"),1]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "Length [Chr 16]", ylab = "Length [cm]", ylim = c(9.5,13), xlab = "Genotypes[UNCHS041714]" , las = 2, t = "n", xaxt = "n")
  axis(1, at = 1:3 , c("TT", "TC", "CC"))
  legend("topright", #bg="gray",
  legend = c( "BFMI-S1", "HET", "BFMI-S2"),
    col = c("lightskyblue1", "cyan3", "dodgerblue4"),
...
# Create one unique Manhattan Plot for Liver and fat
lodannotmatrix <- cbind(annotation[rownames(lodmatrixADD), ], lodmatrixADD)
dataset <- lodannotmatrix[, c("Chromosome", "Position", "Gon", "Leber")]
dataset <- dataset[order(dataset[,"Position"]),]
plot(main = "QTL profile bodyweight [Chr 15]", c(min(as.numeric(dataset[, "Position"])), max(as.numeric(dataset[, "Position"]))), c(0,9), ylab = "-log10 [pvalue]", xlab = "Position [mb]", las = 2, t = "n", xaxt = "n")
  points(x = as.numeric(dataset[,"Position"]), y = dataset[,"Gon"] , col="dodgerblue", lwd = 0.7)
  points(x = as.numeric(dataset[,"Position"]), y = dataset[,"Leber"], col="orange", lwd = 0.7)
  abline(h=4.5, col="green")
  abline(h=4, col="orange")
  axis(1, at = c(0,25000000, 50000000, 75000000, 100000000), c("0", "25", "50", "75", "100"))
  legend("topright", bg="gray",
...
plot(x = c(-gap, tail(chr.starts,1)), y = c(-9,9), t = 'n', xlab="Chromosome", ylab="-log10[P]",xaxt='n', xaxs="i", yaxs="i", las=2, main=paste0("Manhattan plots"))
phenotype <- "Gon"
for(chr in chrs){
  onChr <- rownames(map.sorted[map.sorted[,"Chromosome"] == chr,])
  currentADDDOM <- lodmatrixADDDOM[onChr, phenotype]
  ...
  currentADD <- lodmatrixADD[onChr, phenotype]
  if (chr == "X")
    points(x=chr.starts[chr] + map.sorted[onChr,"Position"], y = mprofiles[onChr, phenotype], t ='p', pch = 16, cex = 1.5, col= "cornflowerblue")
  for (p in 1:length(currentADDDOM)){
    pos <- chr.starts[chr] + map.sorted[onChr,"Position"]
    if ((currentADDDOM[p] >  currentDOM[p]) && (currentADDDOM[p] > currentADD[p])){
      if (chr %in% seq(1,20,2))
    ...
    if ((currentDOM[p] >  currentADDDOM[p]) && (currentDOM[p] > currentADD[p])){
      ...
      if ((currentADD[p] >  currentADDDOM[p]) && (currentADD[p] > currentDOM[p])){
        if (chr %in% seq(1,20,2))
          points(x=pos[p], y = currentADD[p], t ='p', pch = 18, cex = 1.5, col= "cornflowerblue")
	else (points(x=pos[p], y = currentADD[p], t ='p', pch = 18, cex = 1.5,col= "cornflowerblue"))
    }
  }
}
phenotype <- "Leber"
for(chr in chrs){
  ...
  currentADD <- lodmatrixADD[onChr, phenotype]
  if (chr == "X")
    points(x=chr.starts[chr] + map.sorted[onChr,"Position"], y = mprofiles[onChr, phenotype], t ='p', pch = 16, cex = 1.5, col= "lightgreen")
  for (p in 1:length(currentADDDOM)){
    pos <- chr.starts[chr] + map.sorted[onChr,"Position"]
    if ((currentADDDOM[p] >  currentDOM[p]) && (currentADDDOM[p] > currentADD[p])){
      if (chr %in% seq(1,20,2))
    ...
    if ((currentDOM[p] >  currentADDDOM[p]) && (currentDOM[p] > currentADD[p])){
      ...
      if ((currentADD[p] >  currentADDDOM[p]) && (currentADD[p] > currentDOM[p])){
        if (chr %in% seq(1,20,2))
          points(x=pos[p], y = currentADD[p], t ='p', pch = 18, cex = 1.5, col= "lightgreen")
	else (points(x=pos[p], y = currentADD[p], t ='p', pch = 18, cex = 1.5,col= "lightgreen"))
    }
  }
}
phenotype <- "Gluc172"
for(chr in chrs){
  ...
  for (p in 1:length(currentADDDOM)){
    ...
    if ((currentADDDOM[p] <  currentDOM[p]) && (currentADDDOM[p] < currentADD[p])){
      if (chr %in% seq(1,20,2))
        points(x=pos[p], y = currentADDDOM[p], t ='p', pch = 0, cex = 1.5, col= "orange")
      else (points(x=pos[p], y = currentADDDOM[p], t ='p', pch = 0, cex = 1.5, col= "orange"))
    }
    if ((currentDOM[p] <  currentADDDOM[p]) && (currentDOM[p] < currentADD[p])){
      if (chr %in% seq(1,20,2))
        points(x=pos[p], y = currentDOM[p], t ='p', pch = 17, cex = 1,5, col= "orange")
      else (points(x=pos[p], y = currentDOM[p], t ='p', pch = 17, cex = 1.5, col= "orange"))
    }
      if ((currentADD[p] <  currentADDDOM[p]) && (currentADD[p] < currentDOM[p])){
        if (chr %in% seq(1,20,2))
          points(x=pos[p], y = currentADD[p], t ='p', pch = 18, cex = 1.5, col= "orange")
	else (points(x=pos[p], y = currentADD[p], t ='p', pch = 18, cex = 1.5,col= "orange"))
    }
  }
}
lim <- par("usr")
...
legend("topright", #bg="gray"
  bty = "n",
  legend = c("Dominance", "Additive", "Dominance dev.", "Gonadal fat", "Liver", "Glucose"),
...
plot(x = c(-gap, tail(chr.starts,1)), y = c(0,9), t = 'n', xlab="Chromosome", ylab="-log10[P]",xaxt='n', xaxs="i", yaxs="i", las=2, main=paste0("Manhattan plots"))
phenotype <- "Gon"
for(chr in chrs){
  onChr <- rownames(map.sorted[map.sorted[,"Chromosome"] == chr,])
  currentADDDOM <- lodmatrixADDDOM[onChr, phenotype]
...
mat <- matrix(c(1,2,3,4), 1, ,byrow = TRUE)
layout(mat, widths = rep.int(4, ncol(mat)))
#chr3
UNC5791802 <- cbind(phenotypes[, "Gon"], t(genotypes["UNC5812781",]))
boxplot(as.numeric(UNC5791802[which(UNC5791802[,2] == "B"),1]), as.numeric(UNC5791802[which(UNC5791802[,2] == "H"),1]), as.numeric(UNC5791802[which(UNC5791802[,2] == "A"),1]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "gWAT weight",  ylab = "Weight [g]", xlab = "UNC5812781 [chr 3]" , las = 2, t = "n", xaxt = "n", ylim = c(0,8))
  axis(1, at = 1:3 , c("TT", "TC", "CC"))
  y1 <- 7
  #lines(c(1,3),c(y1,y1))
...
UNC5791802 <- cbind(phenotypes[, "Gluc172"], t(genotypes["UNC5812781",]))
boxplot(as.numeric(UNC5791802[which(UNC5791802[,2] == "A"),1]), as.numeric(UNC5791802[which(UNC5791802[,2] == "H"),1]), as.numeric(UNC5791802[which(UNC5791802[,2] == "B"),1]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "Blood glucose", ylab = "Glucose [mg/dl]", xlab = "UNC5812781 [chr 3]" , las = 2, t = "n", xaxt = "n", ylim = c(0,700))
  axis(1, at = 1:3 , c("TT", "CT", "CC"))
  y1 <- 550
  #lines(c(1,3),c(y1,y1))
...
boxplot(as.numeric(UNC25805470[which(UNC25805470[,2] == "A"),1]), as.numeric(UNC25805470[which(UNC25805470[,2] == "H"),1]), as.numeric(UNC25805470[which(UNC25805470[,2] == "B"),1]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "gWAT weight", ylab = "Weight [g]", xlab = "UNC25806117 [chr 15]" , las = 2, t = "n", xaxt = "n", ylim = c(0,8))
...
phenos[,"Gluc172"] <- as.numeric(phenos[,"Gluc172"])
phenos[,"Leber"] <- as.numeric(phenos[,"Leber"])
phenos[,"Gon"] <- as.numeric(phenos[,"Gon"])

UNCHS040894 <- as.numeric(unlist(numgeno["JAX00063853",]))
mdata <- data.frame(cbind(glucose = phenos[, "Gluc172"], liver = phenos[, "Leber"], gon = phenos[, "Gon"], geno = UNCHS040894))
isNA <- which(apply(apply(mdata,1,is.na),2,any))
mdata <- mdata[-isNA,]
lmGluc <- lm(glucose ~ liver + gon + geno, data = mdata)
Gluc172.adj <- mdata[,"glucose"] + resid(lmGluc)
mdata <- cbind(mdata, Gluc172.adj)
...
boxplot(as.numeric(mdata[which(mdata[,"geno"] == "A"),5]), as.numeric(mdata[which(mdata[,"geno"] == "H"),5]), as.numeric(mdata[which(mdata[,"geno"] == "B"),5]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "Blood glucose", ylab = "Glucose adjusted [mg/dl]", xlab = "JAX00063853 [chr 15]" , las = 2, t = "n", xaxt = "n", ylim = c(0,700))
  axis(1, at = 1:3 , c("TT", "CT", "CC"))
  y1 <- 200
  #lines(c(1,3),c(y1,y1))
...
#chr17
UNC27568354 <- cbind(phenotypes[, "Gon"], t(genotypes["UNC27568354",]))
boxplot(as.numeric(UNC27568354[which(UNC27568354[,2] == "A"),1]), as.numeric(UNC27568354[which(UNC27568354[,2] == "H"),1]), as.numeric(UNC27568354[which(UNC27568354[,2] == "B"),1]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "gWAT weight", ylab = "Weight [g]", xlab = "UNC27568354 [chr 17]" , las = 2, t = "n", xaxt = "n", ylim = c(0,8))
  axis(1, at = 1:3 , c("AA", "AG", "GG"))
  y1 <- 7
  #lines(c(1,3),c(y1,y1))
...
UNCHS043909 <- cbind(phenotypes[, "Gluc172"], t(genotypes["UNCHS043909",]))
boxplot(as.numeric(UNCHS043909[which(UNCHS043909[,2] == "A"),1]), as.numeric(UNCHS043909[which(UNCHS043909[,2] == "H"),1]), as.numeric(UNCHS043909[which(UNCHS043909[,2] == "B"),1]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "Blood glucose", ylab = "Glucose [mg/dl]", xlab = "UNCHS043909 [chr 17]" , las = 2, t = "n", xaxt = "n", ylim = c(0,700))
  axis(1, at = 1:3 , c("TT", "CT", "CC"))
  y1 <- 550
  #lines(c(1,3),c(y1,y1))
  #lines(c(1,2),c(y1+30,y1+30))
...
boxplot(as.numeric(UNCHS043909[which(UNCHS043909[,2] == "A"),1]), as.numeric(UNCHS043909[which(UNCHS043909[,2] == "H"),1]), as.numeric(UNCHS043909[which(UNCHS043909[,2] == "B"),1]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "Liver weight", ylab = "Weight [g]", xlab = "UNCHS043909 [chr 17]" , las = 2, t = "n", xaxt = "n", ylim = c(0,8))
  axis(1, at = 1:3 , c("AA", "AG", "GG"))
  y1 <- 6
  #lines(c(1,3),c(y1,y1))
  #lines(c(2,3),c(y1+0.7,y1+0.7))
...
phenotypes <- pheno[colnames(genotypes),]
numgeno <- as.numeric(unlist(numgeno["UNCHS040894",]))
mdata <- data.frame(cbind(glucose = phenotypes[, "Gluc172"], liver = phenotypes[, "Leber"], gon = phenotypes[, "Gon"], geno = numgeno))
isNA <- which(apply(apply(mdata,1,is.na),2,any))
mdata <- mdata[-isNA,]
lmGluc <- lm(glucose ~ liver + gon + geno, data = mdata)
Gluc172.adj <- mdata[,"glucose"] + resid(lmGluc)
...
boxplot(as.numeric(mdata[which(mdata[,"geno"] == "B"),1]), as.numeric(mdata[which(mdata[,"geno"] == "H"),1]), as.numeric(mdata[which(mdata[,"geno"] == "A"),1]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "Blood glucose", ylab = "Glucose [mg/dl]", xlab = "Genotype UNCHS040894 [chr 15]" , las = 2, t = "n", xaxt = "n", ylim = c(0,700))
  axis(1, at = 1:3 , c("TT", "CT", "CC"))
  y1 <- 550
  lines(c(1,3),c(y1,y1))
  lines(c(1,2),c(y1+30,y1+30))
...
boxplot(as.numeric(UNC20599050[which(UNC20599050[,2] == "A"),1]), as.numeric(UNC20599050[which(UNC20599050[,2] == "H"),1]), as.numeric(UNC20599050[which(UNC20599050[,2] == "B"),1]), col = c("lightskyblue1", "cyan3", "dodgerblue4"), main = "Gonadal fat weight", ylab = "Weight [Gr.]", xlab = "Genotype UNC20599050 [chr 12]" , las = 2, t = "n", xaxt = "n", ylim = c(0,7))
  axis(1, at = 1:3 , c("AA", "AG", "GG"))
  y1 <- 6
  lines(c(1,3),c(y1,y1))
  #lines(c(2,3),c(y1,y1))
